...
<div class="row justify-content-center text-left">
    <div class="col-lg-12">
        <div class="block-98723 style-43">
            <div class="block-98723__title h3 fw-bold sp-mb-20"><span class="icon"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-014.png" alt="icon"></span><h2 class="in-text"><?php echo esc_attr_x( 'Search', 'submit button', 'twentytwentyone' ); ?></h2></div>
